...
async function GET() {
    try {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from("events").select("*").order("created_at", {
            ascending: false
        });
        if (error) {
...
async function POST(request) {
    try {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from("events").insert([
            {
                title,
                description,
                time,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2c55741f._.js.map