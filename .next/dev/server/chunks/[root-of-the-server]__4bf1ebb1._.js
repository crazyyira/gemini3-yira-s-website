...
async function GET() {
    try {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from("profile").select("*").eq("id", 1).single();
        if (error) {
...
async function PUT(request) {
    try {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from("profile").update({
            name,
            avatar_url,
            tags,
            bio_paragraph_1,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4bf1ebb1._.js.map