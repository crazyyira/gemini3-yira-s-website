...
"[project]/app/api/events/[id]/registrations/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from("event_registrations").select("*").eq("event_id", id).order("created_at", {
            ascending: false
        });
        if (error) {
...
async function POST(request, { params }) {
    try {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from("event_registrations").insert([
            {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a82ff3f8._.js.map