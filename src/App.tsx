    ...
    <main className="relative min-h-screen">
      ...
      <nav className="fixed top-0 left-0 right-0 z-40 px-6 py-8 flex justify-between items-center bg-gradient-to-b from-[#0a0510] to-transparent">
        ...
        <div className="hidden md:flex gap-8 text-xs uppercase tracking-widest text-white/40">
          <a href="#about" className="hover:text-white transition-colors">灵魂拼贴</a>
          <a href="#feed" className="hover:text-white transition-colors">岛屿碎片</a>
          <a href="#events" className="hover:text-white transition-colors">营地集会</a>
          <a href="#contact" className="hover:text-white transition-colors">联系小黑</a>
        </div>
      </nav>
      ...
      {/* Footer */}
      <footer id="contact" className="py-24 px-6 text-center border-t border-white/5">
