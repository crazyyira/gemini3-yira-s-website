    ...
    <section id="about" className="max-w-6xl mx-auto px-6 py-24">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          >
            <p>从印尼的浪尖到阳朔的洞穴，从读诗会的温润到搞砸俱乐部的坦诚。</p>
            <p>我在这里创造一个让城市紧绷的人放松的场域。对我而言，代码与山海并无二致，它们都是通往自由的路径。</p>
            <p className="italic text-amber-200/60">We are all fragments of a larger dream.</p>
          </motion.div>
        </div>
      </div>
    </section>
